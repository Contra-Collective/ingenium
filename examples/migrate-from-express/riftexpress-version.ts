// RiftExpress version — the "after" snapshot.
// Run with: npm run riftexpress   (listens on http://localhost:3002)
//
...
console.log(`RiftExpress listening on http://localhost:${server.port}`)

// Graceful shutdown — the Express equivalent is "nothing": Express drops
// dead on SIGTERM, killing in-flight requests. RiftExpress ships a small
