...
import { rex, RexUnauthorizedError, type RexPlugin } from 'riftexpress'
...
const authPlugin: RexPlugin<AuthOpts> = (app, opts) => {
...
// Protected route — `requireAuth()` throws RexUnauthorizedError if the
