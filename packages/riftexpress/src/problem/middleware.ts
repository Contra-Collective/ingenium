 ...
 * try/catch and serializes any `RiftexError` (or unknown error) as
 ...
 *
 * @example
 *   app.use(riftex.problemDetails({
 *     typeBaseUrl: 'https://api.example.com/errors/',
 *     includeStack: process.env.NODE_ENV !== 'production',
 *   }))
 */
export function problemDetailsMiddleware(opts: ProblemDetailsOptions = {}): RiftexMiddleware {
