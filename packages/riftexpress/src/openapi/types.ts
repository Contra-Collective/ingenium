/**
 * Minimal OpenAPI 3.1 type surface — just enough for what RiftExpress
...
/** Where a parameter lives. RiftExpress only emits `path` from route syntax. */
