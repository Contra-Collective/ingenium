...
beforeAll(() => {
  ROOT = mkdtempSync(path.join(os.tmpdir(), 'ingenium-static-'))
...
function makeCtx(p: string, headers: Record<string, string> = {}): IngeniumContext {
...
function bodyAsStream(ctx: IngeniumContext): Readable {
